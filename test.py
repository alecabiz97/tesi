# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 21:49:41 2020
...
f=open('Duke_300pics_k_n_withFeedback_Prob1.pkl','wb')
pickle.dump(risultatiTest,f)
f.close()

f=open('Ranks-Duke_300pics_k_n_withFeedback_Prob1.pkl','wb')
pickle.dump(risultatiTest_Ranks,f)
f.close()
...
f=open('Duke_300pics_k_n_withoutFeedback_AQE.pkl','wb')
pickle.dump(risultatiTest,f)
f.close()

f=open('Ranks-Duke_300pics_k_n_withoutFeedback_AQE.pkl','wb')
pickle.dump(risultatiTest_Ranks,f)
f.close()