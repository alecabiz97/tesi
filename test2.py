# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 22:02:33 2020
...
f=open('Duke_test_complete_HumanFeedback_Prob_k55.pkl','wb') 
pickle.dump(results,f)
f.close()

f=open('Ranks-Duke_test_complete_HumanFeedback_Prob_k55.pkl','wb') 
...
f=open('Duke_test_complete_AQE.pkl','wb') 
pickle.dump(results,f)
f.close()

f=open('Ranks-Duke_test_complete_AQE.pkl','wb') 
pickle.dump(results_ranks,f)
f.close()
...
f=open('Duke_test_complete_HumanFeedback_Prob1_k55.pkl','wb') 
pickle.dump(results,f)
f.close()

f=open('Ranks-Duke_test_complete_HumanFeedback_Prob1_k55.pkl','wb') 
pickle.dump(results_ranks,f)
f.close()
...
f=open('Duke_test_complete_soglia0,5.pkl','wb') 
pickle.dump(results,f)
f.close()

f=open('Ranks-Duke_test_complete_soglia0,5.pkl','wb') 
pickle.dump(results_ranks,f)
f.close()