# -*- coding: utf-8 -*-
"""
Created on Sat May 23 10:48:20 2020
...
#Niente feedback e per la similarità la soglia è 0,5
...
for k in [5,15,25,35,45,55]: 
    ...
    print(k)
    for i in range(n):
        query=queryExpansion(ranks_index,ranks_similarity,gallery,query,k,soglia=0.5)
...
f=open('Duke_300pics_k_n_withoutFeedback_soglia0,5_Similarity.pkl','wb')
pickle.dump(risultatiTest,f)
f.close()

f=open('Ranks-Duke_300pics_k_n_withoutFeedback_soglia0,5_Similarity.pkl','wb')
