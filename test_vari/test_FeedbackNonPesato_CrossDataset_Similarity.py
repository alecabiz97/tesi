...
#FEEDBACK NON PESATO con n=3 e k=55. Usata similarità


#Scelta dataset
#Dataset='DukeFromMarket'
#Dataset='MarketFromDuke'
def test_FeedbackNonPesato_CrossDataset_Similarity(Dataset):
    ...
    f=open(Dataset + '_test_complete_Feedback_NonPesato_Similarity.pkl','wb') 
    pickle.dump(results,f)
    f.close()
    
    f=open('Ranks-'+ Dataset + '_test_complete_Feedback_NonPesato_Similarity.pkl','wb') 
