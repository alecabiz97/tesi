...
#Test feedback non pesato con n=3 e k=55
...
f=open(Dataset + '_test_complete_FeedbackNonPesato.pkl','wb') 
pickle.dump(results,f)
f.close()

f=open('Ranks-' + Dataset +'_test_complete_FeedbackNonPesato.pkl','wb') 
